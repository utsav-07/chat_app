        ...
        children: [
          ...
          Material(
            ...
            child: Padding(
              ...
              child: Text(
                '$text',
                style: TextStyle(color: isMe! ? Colors.white : Colors.black54, fontSize: 17.0),
              ),
            ),
          ),
        ],
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var message in messages) {
          ...
          final curruser = _auth.currentUser!.email;
          ...
          child: Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: NetworkImage('https://w0.peakpx.com/wallpaper/418/273/HD-wallpaper-goku-dbz-dragon-ball-dragon-ball-z-goku.jpg'),
                fit: BoxFit.cover
              )
            ),
            child: ListView(
